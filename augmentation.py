...
class GeoTransformation:
    ...
    def __init__(
        ...
        self.keep_aspect_ratio, self.resize_based_crop_size_byon = keep_aspect_ratio, resize_based_on
...
class ComposedTransformation:
    def __init__(
        self,
        rotate_anchors=None, rotate_range=5,
        crop_aspect_ratio=1.0, crop_size=(0.7, 1.0), crop_size_by='longest', hflip=False, vflip=False,
        random_translate=True, min_image_overlap=0.9, min_bbox_overlap=0.99, min_bbox_count=1,
        allow_partial_occurrence=True,
        resize_to=1024, keep_aspect_ratio=False, resize_based_on='longest', max_random_trials=1000,
        ...
        if to_tensor: # EASTDataset에서 tensor화가 이뤄지므로 default값은 False로 설정함.
